...
from WEREWOLF-DEMON.helpers import on_callback, BROADCAST_BUTTONS, BROADCAST_OPTION, MENU1, MENU2, KEYBOARD1, KEYBOARD2
from WEREWOLF-DEMON.functions import (
    check_string,
    get_dialogs,
    userchannels,
    userinfo,
