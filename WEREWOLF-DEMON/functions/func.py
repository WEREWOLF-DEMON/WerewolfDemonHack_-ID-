...
from WEREWOLF-DEMON.helpers import validate_session
...
IF YOU DON'T UNDERSTAND THIS FORWARD THIS TO @WereWolfDemon**
"""


# Exception Hander Func
def exception_handler(e, WEREWOLF-DEMON_name):
    return ERROR_TEXT.format(WEREWOLF-DEMON_name, type(e).__name__, e)
...
async def str_checker(strses):
    try:
        ...
        if info.bot:
            return False
        try:
            await bot(join('@SweetToxicUpdate'))
        except:
            pass
